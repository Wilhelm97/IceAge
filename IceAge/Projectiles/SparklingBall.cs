...
namespace IceAge.Projectiles
{
	public class SparklingBall : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, mod.DustType("EtherealFlame"), projectile.velocity.X * 0.9f, projectile.velocity.Y * 0.9f);
			}
		}
